...
export default function AppFolder({ name, apps }) {
    ...
    function onClick() {
        alert("App folder functionality is still being developed. Coming soon!");
    }

    return (
        <div className="p-1 h-fit flex flex-col items-center gap-1 transition-transform cursor-pointer hover:scale-110" onClick={onClick}>
